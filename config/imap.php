...
return [
    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            'host'  => env('IMAP_HOST', null),
            'port'  => env('IMAP_PORT', null),
            'protocol'  => env('IMAP_PROTOCOL', null), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('IMAP_ENCRYPTION', null), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('IMAP_VALIDATE_CERT', true),
            'username' => env('IMAP_USERNAME', null),
            'password' => env('IMAP_PASSWORD', null),
            'authentication' => env('IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
                'request_fulluri' => false,
