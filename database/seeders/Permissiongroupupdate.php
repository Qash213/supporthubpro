...
class Permissiongroupupdate extends Seeder
{
    ...
    public function updatePermissions()
    {
        ...
        {
            $announcement->permissionsgroupname = 'Announcements';
            $announcement->update();
        }
        //Email Template
        ...
        $per = [
            ...
            ['id' => 146, 'name' => 'Addon Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Addons'],
            ['id' => 147, 'name' => 'Addon Add'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Addons'],
            ['id' => 148, 'name' => 'Addon Edit'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Addons'],
            ['id' => 149, 'name' => 'Email Update'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Profile Edit'],

            ['id' => 150, 'name' => 'Bot Response Setting Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'App Setting'],
            ['id' => 151, 'name' => 'Twilio Setting Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'App Setting'],

            // Livechat perimissions
            ['id' => 152, 'name' => 'Livechat Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Livechat'],
            ['id' => 153, 'name' => 'Customer Chat Process'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Livechat'],
            ['id' => 154, 'name' => 'Operators'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Livechat'],
            ['id' => 155, 'name' => 'Chat Flows'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Livechat'],
            ['id' => 156, 'name' => 'Livechat Settings'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Livechat'],
            ['id' => 157, 'name' => 'Livechat Ratings'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Livechat'],
            ['id' => 158, 'name' => 'Domain Transfer Access'  , 'guard_name' => 'web', 'permissionsgroupname' => 'Domain Transfer'],
        ];
