													...
													<div class="card-body">
														...
														<form method="POST" action="{{url('/contact-us')}}">
															...
															<div class="text-start">
                                                                <button type="submit" class="btn btn-secondary waves-effect waves-light" onclick="this.disabled=true;this.innerHTML=`Sending <i class='fa fa-spinner fa-spin'></i>`;this.form.submit();">{{lang('Send Message')}}</button>
															</div>
														</form>
													</div>
												</div>
