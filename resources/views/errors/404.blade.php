		...
		<div class="page error-bg">
			<div class="page-content m-0">
				<div class="container text-center">
					<div class="display-1 text-primary mb-5 font-weight-bold">{{lang('404')}}</div>
					...
					<a class="btn btn-success" href="{{route('previous.notfound')}}"><i class="fe fe-arrow-left-circle me-1"></i>{{lang('Back to Home')}}</a>
				</div>
			</div>
		</div>
		<!--Row-->
