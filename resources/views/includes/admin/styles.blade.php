		...
		{{-- <link href="{{asset('build/assets/css/animated.css')}}?v=<?php echo time(); ?>" rel="stylesheet" /> --}}

		<!--Sidemenu css -->
        @vite(['resources/assets/custom-theme/sidemenu.scss'])
		{{-- <link href="{{asset('build/assets/css/sidemenu.css')}}?v=<?php echo time(); ?>" rel="stylesheet" /> --}}
		...
		<link href="{{asset('build/assets/plugins/ratings/jquerystarrating.css')}}?v=<?php echo time(); ?>" rel="stylesheet" />
