@php
    $notifys = auth()->guard('customer')->user()->unreadNotifications()->paginate(2);
...
<li class="dropdown me-3 header-message">
    ...
    <div
        class="dropdown-menu dropdown-menu-end dropdown-menu-arrow p-0 notification-dropdown-container">
        ...
        <div class=" text-center p-2">
            <a href="{{ route('client.notification') }}"
                class="cmark-all">{{ lang('See All Notifications', 'notification') }}
            </a>
        </div>
    </div>
