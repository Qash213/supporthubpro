													...
													<div class="card-body text-center item-user">
														<div class="profile-pic">
															<div class="profile-pic-img">
																...
																<img src="{{ route('getprofile.url', ['imagePath' =>Auth::guard('customer')->user()->image,'storage_disk'=>Auth::guard('customer')->user()->storage_disk ?? 'public']) }}" class="brround avatar-xxl"
																	alt="{{Auth::guard('customer')->user()->image}}">
																{{-- <img src="@if(Str::contains(Auth::guard('customer')->user()->image, "storj")) {{ route('profile.url', ['imagePath' =>Auth::guard('customer')->user()->image]) }} @else {{asset('uploads/profile/'.Auth::guard('customer')->user()->image)}} @endif" class="brround avatar-xxl"
																	alt="{{Auth::guard('customer')->user()->image}}"> --}}
																@endif
