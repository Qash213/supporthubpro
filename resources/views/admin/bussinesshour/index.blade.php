                                    ...
                                    <div class="file-image-1 ms-sm-auto sprukologoss ms-sm-auto">
                                        <div class="product-image sprukologoimages">
                                            ...
                                            <img src="{{asset('uploads/support/'. setting('supporticonimage'))}}"
                                                class="br-5" alt="logo">
                                            @else
                                            <img src="{{asset('build/assets/images/support/support.png')}}" class="br-5"
                                                alt="logo">
                                            @endif
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#24hoursbusinessswitch').on('change', function(e){
            ...
            let textdata;
            if(fullhours == 'on'){
                textdata = 'If you enable this all business hours are set to be 24/7 format, then holidays are not showing anymore.';
            }else{
                textdata = 'If you disable this, the 24/7 timings are disclosed you can change business hour timings accordingly to your concern.';
            }

            swal({
                title: `{{ lang('Are you sure you want to continue?', 'alerts') }}`,
                text: `{{ lang('${textdata}', 'alerts') }}`,
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
