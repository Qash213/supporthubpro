...
<div class="col-xl-12 col-lg-12 col-md-12">
    <div class="card ">
        ...
        <form method="POST" action="{{url('/admin/agentprofile/' . encrypt($user->id))}}" enctype="multipart/form-data">
            <div class="card-body" >
                @csrf
                        ...
                        @if ($user->image != null)
                            <div class="file-image-1 removesprukoi{{$user->id}}">
                                <div class="product-image custom-ul">
                                    <a href="#">
                                        <img src="{{ route('getprofile.url', ['imagePath' =>$user->image,'storage_disk'=>$user->storage_disk ?? 'public']) }}" class="br-5" alt="{{$user->image}}">
                                    </a>
                                    <ul class="icons">
            ...
            <div class="card-footer">
                <div class="form-group float-end">
                    <button type="submit" class="btn btn-secondary" onclick="this.disabled=true;this.innerHTML=`Updating <i class='fa fa-spinner fa-spin'></i>`;this.form.submit();">{{lang('Update Profile')}}</button>
                </div>
            </div>
        </form>
    </div>
