		...
		<form method="POST" action="{{url('/admin/agent')}}" enctype="multipart/form-data">
			...
			<div class="col-md-12 card-footer">
				<div class="form-group float-end">
                    <button type="submit" class="btn btn-secondary" onclick="this.disabled=true;this.innerHTML=`Saving <i class='fa fa-spinner fa-spin'></i>`;this.form.submit();">{{lang('Create Employee', 'menu')}}</button>
				</div>
			</div>
		</form>
	</div>
