                                        ...
                                        <div class="col-xl-5 col-lg-3 col-md-3 col-sm-3">
                                            <div class="file-image-1 ms-sm-auto sprukologoss ms-sm-auto">
                                                <div class="product-image sprukologoimages">
                                                    ...
                                                    @else
                                                        <button
                                                            class="btn ticketnotedelete border-white text-gray logosdelete"
                                            ...
                                            <div class="file-image-1 ms-sm-auto">
                                                <div class="product-image sprukologoimages">
                                                    ...
                                                    @else
                                                        ...
                                                        <img src="{{ asset('uploads/logo/favicons/' . $title->image4) }}"
                                                            class="br-5" alt="">
                                                    @endif
                                                </div>
                                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="form-group ">
                                    <label for=""
                                        class="form-label">{{ lang('Terms of service Url', 'setting') }} <span
                                            class="text-red">*</span></label>
                                    <input class="form-control {{ $errors->has('terms_url') ? ' is-invalid' : '' }}"
                                        placeholder="{{ lang('https://example.com') }}" name="terms_url" type="text"
                ...
                <form action="{{ route('settings.contactemail.store') }}" method="POST">
                    <div class="switch_section my-0 ps-3">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="CONTACT_ENABLE" id="contact"
                                    class=" toggle-class onoffswitch2-checkbox" value="yes"
                                    @if (setting('CONTACT_ENABLE') == 'yes') checked="" @endif>
                            ...
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you enable this setting, the "Contact Us" option will appear in the application’s landing page.', 'setting') }})</i></small>
                        </div>
                    </div>
                    @csrf
                    <div class="card-body pt-2">
                        <div class="form-group d-flex d-md-max-block">
                            ...
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('Enter an email address to receive contact-us form details.', 'setting') }})</i></small>
                        </div>
                        <div class="col-xl-6">
                            <input type="email" placeholder="{{ lang('admin@example.com') }}"
                                name="contact_form_mail"
                                class="form-control @error('contact_form_mail') is-invalid @enderror"
                                value="{{ old('contact_form_mail', setting('contact_form_mail')) }}">
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="switch_section">
                                        <div class="switch-toggle d-flex mt-4">
                                            <a class="onoffswitch2">
                                                <input type="checkbox" id="cust_google_two_fact"
                                                    name="Customer_google_two_fact" value="on"
                                                    class=" toggle-class onoffswitch2-checkbox"
                                                    @if (setting('Customer_google_two_fact') == 'on') checked="" @endif>
                                                <label for="cust_google_two_fact"
                                                    class="toggle-class onoffswitch2-label"></label>
                                            </a>
                                            <div class="ps-3">
                                                <label
                                                    class="form-label">{{ lang('Enable Customer Google Two Factor Authentication', 'setting') }}<small
                                                        class="text-muted ">
                                                        <i>({{ lang('If you enable this setting, the application "customers" will be able to use "Google Two Factor Authentication" for login into our appliation.', 'setting') }})</i></small></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="switch_section">
                                        <div class="switch-toggle d-flex mt-4">
                                            <a class="onoffswitch2">
                                                <input type="checkbox" id="cust_email_two_fact"
                                                    name="Customer_email_two_fact" value="on"
                                                    class=" toggle-class onoffswitch2-checkbox"
                                                    @if (setting('Customer_email_two_fact') == 'on') checked="" @endif>
                                                <label for="cust_email_two_fact"
                                                    class="toggle-class onoffswitch2-label"></label>
                                            </a>
                                            <div class="ps-3">
                                                <label
                                                    class="form-label">{{ lang('Enable Customer Email Two Factor Authentication', 'setting') }}<small
                                                        class="text-muted">
                                                        <i>({{ lang('If you enable this setting, the application "customers" will be able to use "Email Two Factor Authentication" for login into our appliation.', 'setting') }})</i></small></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <form action="{{ route('admin.customerautologout') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div class="col-sm-12 col-md-12">
                                <div
                                    class="form-group {{ $errors->has('customer_inactive_auto_logout') ? ' has-danger' : '' }}">
                                    <div class="switch_section">
                                        <div class="switch-toggle d-flex mt-4">
                                            <a class="onoffswitch2">
                                                <input type="checkbox" id="myonoffswitchautologout"
                                                    name="customer_inactive_auto_logout" value="on"
                                                    class=" toggle-class onoffswitch2-checkbox"
                                                    @if (setting('customer_inactive_auto_logout') == 'on') checked="" @endif>
                                                <label for="myonoffswitchautologout"
                                                    class="toggle-class onoffswitch2-label"></label>
                                            </a>
                                            <div class="ps-3">
                                                <label
                                                    class="form-label">{{ lang('Enable Customer Dashboard Session Timeout', 'setting') }}<small
                                                        class="text-muted ">
                                                        <i>({{ lang('If you enable this setting, customers will be automatically logged out based on their session time (set in minutes) below. This feature helps enhance security and privacy for customers.', 'setting') }})</i></small></label>

                                            </div>
                                        </div>
                                    </div>
                                    @if ($errors->has('customer_inactive_auto_logout'))
                                        <span class="invalid-feedback d-block" role="alert">
                                            <strong>{{ $errors->first('customer_inactive_auto_logout') }}</strong>
                                        </span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 ms-7 ps-3 ">
                                <div
                                    class="form-group d-flex d-md-max-block {{ $errors->has('customer_inactive_auto_logout_time') ? ' is-invalid' : '' }}">
                                    <input type="number" maxlength="2" class="form-control wd-5 w-lg-max-30 ms-2 "
                                        name="customer_inactive_auto_logout_time"
                                        value="{{ old('customer_inactive_auto_logout_time', setting('customer_inactive_auto_logout_time')) }}"  min="0" oninput="validity.valid||(value='');">
                                    <label
                                        class="form-label mt-2 ms-2">{{ lang('Session Timeout In Minutes', 'setting') }}</label>
                                </div>
                                @if ($errors->has('customer_inactive_auto_logout_time'))
                                    <span class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $errors->first('customer_inactive_auto_logout_time') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
                ...
                <form action="{{ route('admin.customerprofiledelete') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-bottom">
                            <div class="col-sm-12 col-md-12">
                                <div
                                    class="form-group {{ $errors->has('customer_inactive_notify') ? ' has-danger' : '' }}">
                                    <div class="switch_section">
                                        <div class="switch-toggle d-flex mt-4">
                                            <a class="onoffswitch2">
                                                <input type="checkbox" id="myonoffswitch18"
                                                    name="customer_inactive_notify" value="on"
                                                    class=" toggle-class onoffswitch2-checkbox"
                                                    @if (setting('customer_inactive_notify') == 'on') checked="" @endif>
                                                <label for="myonoffswitch18"
                                                    class="toggle-class onoffswitch2-label"></label>
                                            </a>
                                            <div class="ps-3">
                                                <label
                                                    class="form-label">{{ lang('Customer Profile Auto Delete Enable', 'setting') }}</label>
                                                <small class="text-muted ">
                                                    <i>({{ lang('If you enable this setting, inactive customer will receive an email after the time period specified below (Inactive Months) stating that their account has been unused since the specified days and will be deleted automatically after the specified (Customer Delete Days).', 'setting') }})</i></small>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-12 col-md-12 ms-7 ps-3 ">
                                <div
                                    class="form-group d-flex d-md-max-block {{ $errors->has('customer_inactive_notify_date') ? ' is-invalid' : '' }}">
                                    <input type="number" maxlength="2" class="form-control wd-5 w-lg-max-30 ms-2 "
                                        name="customer_inactive_notify_date"
                                        value="{{ old('customer_inactive_notify_date', setting('customer_inactive_notify_date')) }}"
                            ...
                            <div class="col-sm-12 col-md-12 ms-7">
                                <div
                                    class="form-group d-flex d-md-max-block {{ $errors->has('customer_inactive_week_date') ? ' is-invalid' : '' }}">
                                    <input type="number" maxlength="2" class="form-control wd-5 w-lg-max-30 ms-2"
                                        name="customer_inactive_week_date"
                                        value="{{ old('customer_inactive_week_date', setting('customer_inactive_week_date')) }}"
                                        min="0" oninput="validity.valid||(value='');">
                                    <label
                                        class="form-label  mt-2 ms-2">{{ lang('Customer Delete Days', 'setting') }}</label>
                                </div>
                        ...
                        <div>
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group {{ $errors->has('guest_inactive_notify') ? ' has-danger' : '' }}">
                                    <div class="switch_section">
                                        <div class="switch-toggle d-flex mt-4">
                                            <a class="onoffswitch2">
                                                <input type="checkbox" id="guestdelete" name="guest_inactive_notify"
                                                    value="on" class=" toggle-class onoffswitch2-checkbox"
                                                    @if (setting('guest_inactive_notify') == 'on') checked="" @endif>
                                                <label for="guestdelete" class="toggle-class onoffswitch2-label"></label>
                                            </a>
                                            <div class="ps-3">
                                                <label
                                                    class="form-label">{{ lang('Guest Profile Auto Delete Enable', 'setting') }}</label>
                                                <small class="text-muted ">
                                                    <i>({{ lang('If you enable this setting, inactive Guest will receive an email after the time period specified below (Inactive Months) stating that their account has been unused since the specified days and will be deleted automatically after the specified (Guest Delete Days).', 'setting') }})</i></small>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-12 col-md-12 ms-7 ps-3 ">
                                <div
                                    class="form-group d-flex d-md-max-block {{ $errors->has('guest_inactive_notify_date') ? ' is-invalid' : '' }}">
                                    <input type="number" maxlength="2" class="form-control wd-5 w-lg-max-30 ms-2 "
                                        name="guest_inactive_notify_date"
                                        value="{{ old('guest_inactive_notify_date', setting('guest_inactive_notify_date')) }}"
                                        min="0" oninput="validity.valid||(value='');">
                                    <label class="form-label mt-2 ms-2">{{ lang('Inactive Months', 'setting') }}</label>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12 ms-7">
                                <div
                                    class="form-group d-flex d-md-max-block {{ $errors->has('guest_inactive_week_date') ? ' is-invalid' : '' }}">
                                    <input type="number" maxlength="2" class="form-control wd-5 w-lg-max-30 ms-2"
                                        name="guest_inactive_week_date"
                                        value="{{ old('guest_inactive_week_date', setting('guest_inactive_week_date')) }}"
                                        min="0" oninput="validity.valid||(value='');">
                                    <label
                                        class="form-label  mt-2 ms-2">{{ lang('Guest Delete Days', 'setting') }}</label>
                                </div>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="checkbox" id="sprukoadminc"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister"
                                    @if (setting('SPRUKOADMIN_C') == 'on') checked="" @endif>
                                <label for="sprukoadminc" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Enable Dark Mode Switch For All Customer’s', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you disable this setting, the "Switch to Dark-Mode" option will disappear from the Customer’s profile page. And global "Dark-Mode" settings will not apply for customers.', 'setting') }})</i></small>
                        </div>
                    </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="REGISTER_POPUP" id="myonoffswitch1"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('REGISTER_POPUP') == 'yes') checked="" @endif>
                                <label for="myonoffswitch1" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Enable Popup Register/Login', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you enable this setting, customers can access the registration form or login form in “popup modal” only.', 'setting') }})</i></small>
                        </div>
                    </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="REGISTER_DISABLE" id="REGISTER_DISABLE"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="off"
                                    @if (setting('REGISTER_DISABLE') == 'off') checked="" @endif>
                            ...
                            <a href="javascript:void(0);" class="ps-1 sprukologindisable"><i
                                    class="feather feather-edit-2"></i></a>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you enable this setting, "Register" options will disappear from the application’s header section, and new visitors wont be able to register to the application.', 'setting') }})</i></small>
                        </div>
                    </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            ...
                            <a class="onoffswitch2">
                                <input type="checkbox" name="login_disable" id="login_disable"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('login_disable') == 'on') checked="" @endif>
                                <label for="login_disable" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label class="form-label ps-3 ps-md-max-0">{{ lang('Login Disable', 'setting') }}</label><a
                                href="javascript:void(0);" class="ps-1 sprukologindisable"><i
                                    class="feather feather-edit-2"></i></a>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you enable this setting, Customers cannot login to their accounts.', 'setting') }})</i></small>
                        </div>
                    </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            ...
                            <a class="onoffswitch2">
                                <input type="checkbox" name="PROFILE_USER_ENABLE" id="myonoffswitch123"
                                    class=" toggle-class onoffswitch2-checkbox" value="yes"
                                    @if (setting('PROFILE_USER_ENABLE') == 'yes') checked="" @endif>
                                <label for="myonoffswitch123" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Enable Customer Profile Image Upload', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you disable this setting, the "Upload File" option will disappear from the customers profile page, and they wont be able to upload their profile picture.', 'setting') }})</i></small>
                        </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="defaultlogin_on" id="defaultlogin_on"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('defaultlogin_on') == 'on') checked="" @endif>
                            ...
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you enable this setting, login page will appear on the main site URL by default. Users cannot access the homepage', 'setting') }})</i></small>
                        </div>
                    </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="only_social_logins" id="only_social_logins"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('only_social_logins') == 'on') checked="" @endif>
                                <label for="only_social_logins" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Social Login’s Only', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you enable this setting, only social login form will appear to customer’s by when you click on the login button in header section. They cannot access normal login form', 'setting') }})</i></small>
                        </div>
                    </div>
                    ...
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            ...
                            <a class="onoffswitch2">
                                <input type="checkbox" name="cust_profile_delete_enable" id="cust_profile_delete_enable"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('cust_profile_delete_enable') == 'on') checked="" @endif>
                                <label for="cust_profile_delete_enable" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Customer Account Delete Permission', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you "Enable" this setting, customers can "Delete" their account permanently.', 'setting') }})</i></small>
                        </div>
                    </div>
                    <!--- End Customer Profile Delete Enable --->

                    <!--- Customer Email Update Enable --->
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="cust_email_update" id="cust_email_update"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('cust_email_update') == 'on') checked="" @endif>
                                <label for="cust_email_update" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Customer Email Update Permission', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you "Enable" this setting, customers can "Update" their email address.', 'setting') }})</i></small>
                        </div>
                    </div>
                    <!--- End Customer Email Update  Enable --->

                    <!--- Customer Mobile Number Update Enable --->
                    <div class="switch_section">
                        <div class="switch-toggle d-flex d-md-max-block mt-4">
                            <a class="onoffswitch2">
                                <input type="checkbox" name="cust_mobile_update" id="cust_mobile_update"
                                    class=" toggle-class onoffswitch2-checkbox sprukoregister" value="yes"
                                    @if (setting('cust_mobile_update') == 'on') checked="" @endif>
                                <label for="cust_mobile_update" class="toggle-class onoffswitch2-label"></label>
                            </a>
                            <label
                                class="form-label ps-3 ps-md-max-0">{{ lang('Customer Mobile Number Update Permission', 'setting') }}</label>
                            <small
                                class="text-muted ps-2 ps-md-max-0"><i>({{ lang('If you "Enable" this setting, customers can "Update" their Mobile Number.', 'setting') }})</i></small>
                        </div>
                    </div>
                    <!--- End Customer Mobile Number Update  Enable --->
    ...
    <script type="text/javascript">
        $(function() {
            ...
            (() => {
                ...
                let themeColorDark = setColorPicker('#theme_color_dark-input', document.querySelector(
                    '#theme_color_dark-input').value);
                ...
                $('.sprukoregister').on('change', function() {
                    ...
                    var custemailupdate = $('#cust_email_update').prop('checked') == true ? 'on' : 'off';
                    var custmobileupdate = $('#cust_mobile_update').prop('checked') == true ? 'on' : 'off';
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            'custemailupdate': custemailupdate,
                            'custmobileupdate': custmobileupdate,
                        ...
                        error: function(data) {
                            if(data?.responseJSON?.twilioerror){
                                toastr.error(data.responseJSON.twilioerror);
                            }
