    ...
    <div class="page-header d-xl-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title"><span
                    class="font-weight-normal text-muted ms-2">{{ lang('Message Template', 'menu') }}</span></h4>
        </div>
    </div>
    <!--End Page header-->
        ...
        <div class="col-xl-8 col-lg-12 col-md-12">
            <div class="card ">
                <div class="card-header border-0 d-flex">
                    <h4 class="card-title">{{ lang('Message Template') }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.smstemplate.update', [$template->id]) }}"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label class="form-label">{{ lang('Message Body') }} <span
                                            class="text-red">*</span></label>
                                    <textarea class="form-control summernote @error('body') is-invalid @enderror" placeholder="{{ lang('Message Body') }}"
        ...
        <div class="col-xl-4 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-0">
                    <h4 class="card-title">{{ lang('Message Template Fields') }}</h4>
                </div>
                <div class="card-body">
                    @php
