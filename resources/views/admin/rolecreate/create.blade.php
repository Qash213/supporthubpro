							...
							<div class="col-xl-12 col-lg-12 col-md-12">
								<div class="card ">
									...
									<div class="card-header border-0">
										<h4 class="card-title">{{lang('Create Role & Permissions')}}</h4>
										...
										<div class="card-body" >
											...
											<div class="row">
												<div class="col-sm-12 col-md-12">
													<div class="">
														<div class="form-group">
															<label class="form-label ">{{lang('Role Name')}} <span class="text-red">*</span></label>
												...
												<div class="col-sm-12 col-md-12">
													<div class="form-group">
														...
														<div class="row">
															...
															@foreach($permission as $groupname => $permision)

															<div class="col-sm-12 col-md-12">
																<h5 class="roles-title">{{$groupname}}</h5>
															</div>

																@foreach($permision as $permissions)
																	<div class="col-xl-3">
