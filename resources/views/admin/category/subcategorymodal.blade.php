            ...
            <form method="POST" enctype="multipart/form-data" id="subcategory_form" name="subcategory_form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xl-3 col-md-12">
                                <label class="form-label d-flex align-items-center me-6">{{lang('Name')}} <span class="text-red ms-1">*</span> </label>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xl-3 col-md-12">
                                <label class="form-label d-flex align-items-center me-6">{{lang('Parent Category')}} </label>
                            </div>
                            <div class="col-xl-9 col-md-12">
                                <select name="parent_id[]" id="parent_id" class="categorysub form-control" data-placeholder="{{lang('Select Category')}}" multiple>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xl-3 col-md-12">
                                <label class="form-label pe-1 me-0">{{lang('Status')}}:</label>
                            </div>
                            <div class="col-xl-9 col-md-12">
