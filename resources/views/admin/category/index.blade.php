                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (Auth::user()->can('Category Delete'))
                                            <input type="checkbox" name="student_checkbox[]" class="checkall"
                                                value="{{ $category->id }}" />
                                        @else
                                            <input type="checkbox" name="student_checkbox[]" class="checkall"
                                    ...
                                    <td>
                                        @if (Auth::user()->can('Category Assign To Groups'))
                                            @if ($category->display == 'ticket' || $category->display == 'both')
                                                <a href="javascript:void(0)" data-id="{{ $category->id }}" id="assigneds"
                                                    class="badge badge-pill badge-info mt-2" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="{{ lang('Assign to group') }}">
                                        ...
                                        @if (Auth::user()->can('Category Edit'))
                                            @if ($category->status == '1')
                                                <label class="custom-switch form-switch mb-0">
                                                    <input type="checkbox" name="status" data-id="{{ $category->id }}"
                                                        id="myonoffswitch{{ $category->id }}" value="1"
                                        ...
                                        <div class = "d-flex">
                                            @if (Auth::user()->can('Category Edit'))
                                                <a href="javascript:void(0)" data-id="{{ $category->id }}"
                                                    class="action-btns1 edit-testimonial">
                                                    <i class="feather feather-edit text-primary"
                                            ...
                                            @else
                                                ~
                                            @endif
                                            @if (Auth::user()->can('Category Delete') && $category->groupscategoryc()->count() == 0)
                                                <a href="javascript:void(0)" data-id="{{ $category->id }}"
                                                    class="action-btns1 delete-category">
                                                    <i class="feather feather-trash-2 text-danger"
                                                        data-id="{{ $category->id }}"data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="{{ lang('Delete') }}"></i>
                                                </a>
                                            @else
                                                ~
                                            @endif
        ...
        $(function() {
            ...
            (function($) {
                ...
                $('body').on('submit', '#group_form', function(e) {
                    ...
                    var fewSeconds = 2;
                    $('#btngroup').html('Sending ... <i class="fa fa-spinner fa-spin"></i>');
