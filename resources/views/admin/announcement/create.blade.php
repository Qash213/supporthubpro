        ...
        <form method="POST" enctype="multipart/form-data" id="testimonial_form" name="testimonial_form">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  name = "notice" id="description" ></textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group ">
                            ...
                            <input class="form-control" name="buttonlable" type="text" value="" id="buttonlable">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group ">
                            <label for="" class="form-label">{{lang('Button Url', 'general')}} <span>({{ lang('optional') }})</span></label>
                            <input class="form-control" name="buttonurl" type="text" value="" id="buttonurl">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group ">
                            ...
                            <input class="form-control {{ $errors->has('primary_color') ? ' is-invalid' : '' }}" name="primary_color" type="text" value="rgba(228, 238, 251, 1)" id="primary_color-input">
            ...
            $('body').on('submit', '#testimonial_form', function (e) {
                ...
                $.ajax({
                    ...
                    error: function(data){
                        ...
                        $('#buttonurlError').html(data.responseJSON?.errors?.buttonurl);
