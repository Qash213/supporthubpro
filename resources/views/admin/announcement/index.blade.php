					...
					<div class="switch_section mt-2 mb-2">
						<div class="switch-toggle d-flex ">
							...
							<div class="ps-3">
								...
								<small class="text-muted"><i>({{lang('If you enable this "Non Login Users" setting feature, the "Announcement" will appear for the non login users on the "Application."', 'setting')}})</i></small>
							</div>
						</div>
					</div>
				</div>
					...
					<tbody>
						...
						@foreach($announcements as $announcement)
							<tr>
								...
								@else
									<td>{{\Carbon\Carbon::parse($announcement->startdate)->format(setting('date_format'))}}</td>
									<td>{{\Carbon\Carbon::parse($announcement->enddate)->format(setting('date_format'))}}</td>
									<td>~</td>
								@endif
								<td>
