							...
							<tr>
								...
								<td>
									@if(Auth::user()->can('Customers Delete'))
										...
										<input type="checkbox" name="customer_checkbox[]" class="checkall" value="{{encrypt($customer->id)}}" />
									@else

										<input type="checkbox" name="customer_checkbox[]" class="checkall" value="{{encrypt($customer->id)}}" disabled />
									@endif
								</td>
								<td>
									@if(auth()->user()->can('Customers Login'))
										...
										<div>
											...
											@if($customer->voilated == 'on')
												<span class="badge badge-danger-light"><i class="fa fa-exclamation-triangle text-danger"></i> {{__('Violation')}}</span>
											@endif
											<a class="float-xxl-end" href="{{url("/admin/customer/adminlogin/". encrypt($customer->id))}}"  target="_blank">
								...
								<td>
									...
									@if(Auth::user()->can('Customers Edit'))
										...
										<a href="{{url('/admin/customer/' . encrypt($customer->id))}}" class="action-btns1" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Edit')}}">
									...
									@if(Auth::user()->can('Customers Delete'))
										...
										<a href="javascript:void(0)" class="action-btns1" data-id="{{encrypt($customer->id)}}" id="show-delete" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Delete')}}">
									...
									@if($ticketCount > 0)
										<a href="{{route('admin.customer.tickethistory', encrypt($customer->id))}}" class="action-btns1"  target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="{{lang('Tickets History')}}">
