                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" enctype="multipart/form-data"  action="{{url('admin/projectsassigned')}}">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-secondary" id="btnsave" onclick="this.disabled=true;this.innerHTML=`Saving <i class='fa fa-spinner fa-spin'></i>`;this.form.submit();">{{lang('Save')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
