								...
								<div class="col-xl-12 col-lg-12 col-md-12">
									<div class="card">
										<div class="card-header d-block border-0">
											...
											<div class="mt-2">
												<span class="badge badge-light">{{\Carbon\Carbon::parse($notifications->created_at)->timezone(Auth::user()->timezone)->format(setting('date_format'))}}</span>
												<span class="badge badge-light">{{\Carbon\Carbon::parse($notifications->created_at)->timezone(Auth::user()->timezone)->format(setting('time_format'))}}</span>
											</div>
										</div>
