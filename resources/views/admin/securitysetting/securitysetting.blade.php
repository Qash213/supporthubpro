																	...
																	<div class="row">
																		<div class="col-lg-12">
																			<div class="form-group sprukotag">
																				<input name="emaildomain" placeholder="Ex:	gmail.com, yahoo.com, spruko.com" id = "tags" class="form-control"  data-role="tagsinput" value="{{old('emaildomain', setting('EMAILDOMAIN_LIST')) }}">
