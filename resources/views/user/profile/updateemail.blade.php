...
@section('content')
    ...
    <form class="card-body pt-3 pb-0 newone d-none" id="newone" action="{{route('emailchange.otpverify',$oldemail)}}" method="post">
        @csrf
    ...
    $(function() {
        ...
        (function($){
            ...
            $('body').on('submit', '#emailstore', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: SITEURL + "/customer/customernewemailstore",
                    data: formData,
