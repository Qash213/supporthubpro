        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="border p-4">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <span>Created - {{\Carbon\Carbon::parse($showprintticket->created_at)->timezone(setting('default_timezone'))->format('d-m-y')}} {{\Carbon\Carbon::parse($showprintticket->created_at)->timezone(setting('default_timezone'))->format('h:i A')}}</span>
                        </div>
                        <div class="col-6">
                            <span>By
                ...
                <div class="border p-4 mt-2">
                    ...
                    <div>
                        ...
                        @if($commentsprint->cust != null)
                            ...
                            <img class="media-object brround avatar-lg" alt="{{$commentsprint->cust->image}}" src="{{ route('getprofile.url', ['imagePath' =>$commentsprint->cust->image,'storage_disk'=>$commentsprint->cust->storage_disk ?? 'public']) }}">
                            @endif
                        @else
                    ...
                    <div class="row">
                        <div class="col-6">
                            <span>{{lang('Created')}} - {{\Carbon\Carbon::parse($commentsprint->created_at)->timezone(setting('default_timezone'))->format('d-m-y')}}
                                {{\Carbon\Carbon::parse($showprintticket->created_at)->timezone(setting('default_timezone'))->format('h:i A')}}</span>
                        </div>
                        <div class="col-6">
                ...
                @if($commentsprint->user_id != null)
                    {{--Admin Reply status--}}
                        ...
                        <div class="border p-4 mt-2">
                            ...
                            <div>
                                ...
                                @else
                                    @if($commentsprint->user != null)
                                        ...
                                        <img class="media-object brround avatar-lg" alt="{{$commentsprint->user->image}}" src="{{ route('getprofile.url', ['imagePath' =>$commentsprint->user->image,'storage_disk'=>$commentsprint->user->storage_disk ?? 'public']) }}">
                                        @endif
                                    @else
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span>{{lang('Created')}} - {{\Carbon\Carbon::parse($commentsprint->created_at)->timezone(setting('default_timezone'))->format('d-m-y')}} {{\Carbon\Carbon::parse($showprintticket->created_at)->timezone(setting('default_timezone'))->format('h:i A')}}</span>
                                </div>
                                <div class="col-6">
                                    <span>{{lang('Replied By')}}
                                        @if($commentsprint->user_id == null)
