                                                ...
                                                @foreach ($arraytype as $arraytypes)
                                                    ...
                                                    <div class="border d-table rounded attach-container-width mb-2">
                                                        <div class="d-flex align-items-center file-attach-uhelp">
                                                            ...
                                                            <div
                                                                class="d-flex align-items-center text-muted fs-12 me-3">
                                                    ...
                                                    <div class="border d-table rounded attach-container-width mb-2">
                                                        <div class="d-sm-flex align-items-center file-attach-uhelp">
                                                            ...
                                                            <div class="d-flex mt-2 mt-sm-0">
                                                                <a href="{{ route('imageurl', [$commentss->id, $commentss->file_name]) }}"
                                                                    target="_blank"
                                                                    class=" uhelp-attach-acion p-2 rounded border lh-1 me-1 d-flex align-items-center justify-content-center"><i
                                                                        class="fe fe-eye text-muted fs-12"></i></a>
                                                                <a href="{{ route('imagedownload', [$commentss->id, $commentss->file_name]) }}"
                                                                    class="uhelp-attach-acion p-2 rounded border lh-1 d-flex align-items-center justify-content-center"><i
                                                                        class="fe fe-download text-muted fs-12"></i></a>
                                                            </div>
                                                        </div>
