@if(auth()->guard('customer')->user())
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="">
                            ...
                            <div class="mt-0 text-start">
                                <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-burnt-orange badge-notify br-13 ms-2 mt-0"> {{lang('Two Factor Authentication', 'notification')}} </span></span>
                                <p class="fs-13 mb-0">{{lang('Your two factor authentication details are removed by admin.', 'notification')}} </strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                    ...
                    @if($notification->read_at != null)
                        ...
                        <div class="card mb-3 notify-read">
                            ...
                            <div class="">
                                ...
                                <div class="mt-0 text-start">
                                    <span class="fs-16 font-weight-semibold">{{Str::limit($notification->data['title'], '50', '...')}} <span class="badge badge-burnt-orange badge-notify br-13 ms-2 mt-0"> @if(isset($notification->data['replystatus']) && $notification->data['replystatus'] == 'Bot-Replied') {{lang('Bot Replied', 'notification')}} @else {{lang('New Ticket', 'notification')}} @endif </span></span>
                                    <p class="fs-13 mb-0">@if(isset($notification->data['replystatus']) && $notification->data['replystatus'] == 'Bot-Replied') {{lang('You got a new reply on this ticket', 'notification')}} @else {{lang('Your new ticket has been created', 'notification')}} @endif <strong>{{ $notification->data['ticket_id'] }}</strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                                </div>
                            </div>
                            <span class="text-end mb-2 me-3 fs-12 text-muted">
                                {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                ...
                @if($notification->data['status'] == 'Closed')
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="mt-0 text-start">
                                ...
                                <p class="fs-13 mb-0">{{lang('Your ticket has been closed', 'notification')}} <strong>{{ $notification->data['ticket_id'] }}</strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                ...
                @if($notification->data['status'] == 'On-Hold')
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="mt-0 text-start">
                                ...
                                <p class="fs-13 mb-0">{{lang('Your ticket status is On-Hold', 'notification')}} <strong>{{ $notification->data['ticket_id'] }}</strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                ...
                @if($notification->data['status'] == 'overdue')
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="mt-0 text-start">
                                ...
                                <p class="fs-13 mb-0">{{lang('Your ticket status is overdue', 'notification')}} <strong>{{ $notification->data['ticket_id'] }}</strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                ...
                @if($notification->data['status'] == 'Re-Open')
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="mt-0 text-start">
                                ...
                                <p class="fs-13 mb-0">{{lang('Your ticket has been Reopened', 'notification')}} <strong>{{ $notification->data['ticket_id'] }}</strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                ...
                @if($notification->data['status'] == 'Inprogress')
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="mt-0 text-start">
                                ...
                                <p class="fs-13 mb-0">{{lang('You got a new reply on this ticket', 'notification')}} <strong>{{ $notification->data['ticket_id'] }}</strong> <a  href="{{$stringreplaceurl}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                ...
                @if ($notification->data['status'] == 'mail')
                    ...
                    <div class="card mb-3 notify-read">
                        ...
                        <div class="mt-0 text-start">
                                ...
                                <p class="fs-13 mb-0 pe-6">{{Str::limit($notification->data['mailtext'], '70')}}<a  href="{{route('customer.notiication.view', $notification->id)}}" data-id="{{$notification->id}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="d-flex p-4 border-bottom-0">
                            ...
                            <div class="mt-0 text-start">
                                <span class="fs-16 font-weight-semibold">{{$notification->data['mailsubject']}} <span class="badge badge-success badge-notify br-13 ms-2 mt-0" style="background-color: {{$notification->data['mailsendtagcolor']}}">{{$notification->data['mailsendtag']}}</span></span>
                                <p class="fs-13 mb-0 pe-6">{{Str::limit($notification->data['mailtext'], '70')}}<a  href="{{route('customer.notiication.view', $notification->id)}}" data-id="{{$notification->id}}" class="ms-3 text-blue mark-as-read">{{lang('View')}}</a></p>
                            </div>
                        </div>
                        <span class="text-end mb-2 me-3 fs-12 text-muted">
                            {{\Carbon\Carbon::parse($notification->created_at)->timezone(Auth::guard('customer')->user()->timezone)->format(setting('time_format'))}}
    ...
    @endforelse
    @if (isset($status))
        {{ auth()->guard('customer')->user()->notifications()->whereIn('data->status', $status)->paginate($perPage, ['*'], 'page', $page)->links('admin.notificationpagination2') }}
    @endif
@endif
