...
<input type="hidden" name="token" value="{{ $token }}">
    ...
    <div class="submit">
    <button type="submit" class="btn btn-secondary btn-block" onclick="this.disabled=true;this.innerHTML=`Logging <i class='fa fa-spinner fa-spin'></i>`;this.form.submit();">
        {{lang('Reset Password')}}
    </button>
    </div>
