        ...
        <div class="login-icons card-body pt-3 pb-0 text-center justify-content-center">
            @if ($socialAuthSettings->envato_status == 'enable')
                <a class="btn header-buttons text-start social-icon-2 btn-lg btn-lime text-white mb-4 btn-block p-0"
                    ...
                    onclick="window.location.href = envato;" data-bs-original-title="{{ lang('Login with Envato') }}">
            ...
            @if ($socialAuthSettings->google_status == 'enable')
                <a class="btn header-buttons text-start social-icon-2 btn-lg btn-google text-white mb-4 btn-block p-0"
                    ...
                    onclick="window.location.href = google;" data-bs-original-title="{{ lang('Login with Google') }}">
    ...
    <div class="card-body border-top-0 pt-3 pb-0">
        ...
        <form method="post" id="register_form">
            ...
            <div class="form-group row">
                <div class="col-sm-6 col-md-6 mb-2 mb-sm-0">
                    ...
                    <input class="form-control @error('firstname') is-invalid @enderror"
                        placeholder="{{ lang('Firstname') }}" type="text" name="firstname"
                        value="{{ old('firstname') }}">
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <input class="form-control @error('lastname') is-invalid @enderror"
                        placeholder="{{ lang('Lastname') }}" type="text" name="lastname" value="{{ old('lastname') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('email') is-invalid @enderror" placeholder="{{ lang('Email') }}"
            ...
            <div class="form-group row">
                <div class="col-sm-6 col-md-6">
                    ...
                    <input class="form-control @error('password') is-invalid @enderror"
                        placeholder="{{ lang('password') }}" type="password" name="password"
                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <input class="form-control @error('password_confirmation') is-invalid @enderror"
                        placeholder="{{ lang('password') }}" type="password" name="password_confirmation"
                        autocomplete="new-password">
    ...
    @endif -->
            ...
            <div class="submit">
                ...
                <button type="submit" class="btn btn-secondary btn-block"
                    id="register_button">{{ lang('Create Account') }}</button>
            ...
            <div class="text-center mt-4">
                ...
                <p class="text-dark mb-0"><a class="text-primary ms-1"
                        href="{{ url('/') }}">{{ lang('Send me Back') }}</a></p>
