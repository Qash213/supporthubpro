                            ...
                            <div class="wrapper wrapper2 box-shadow-0 border-0">
                                    ...
                                    <div class="login-icons card-body pt-3 pb-0 text-center justify-content-center">
                                        @if ($socialAuthSettings->envato_status == 'enable')
                                            <a class="btn header-buttons text-start social-icon-2 btn-lg btn-lime text-white mb-4 btn-block p-0"
                                                ...
                                                <span
                                                    class="px-4 py-2 my-auto text-white">{{ lang('Login with Envato') }}</span>
                                            </a>
                                        @endif
                                        @if ($socialAuthSettings->google_status == 'enable')
                                            <a class="btn header-buttons text-start social-icon-2 btn-lg btn-google text-white mb-4 btn-block p-0"
                                                ...
                                                <span
                                                    class="px-4 py-2 my-auto text-white">{{ lang('Login with Google') }}</span>
                                            </a>
                                        @endif
                                ...
                                <div class="card-body border-top-0 pt-4">
                                    ...
                                    <form id="registerform">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-grouphas-feedback ">
                                                    ...
                                                    <input class="form-control " placeholder="{{ lang('Firstname') }}"
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group has-feedback">
                                                    <label class="form-label">{{ lang('Last Name') }} <span
                                                            class="text-red">*</span></label>
                                                    <input class="form-control " placeholder="{{ lang('Lastname') }}"
                                        ...
                                        <div class="form-group has-feedback">
                                            <label class="form-label" for="emailInput">{{ lang('Email') }} <span
                                                    class="text-red">*</span></label>
                                        ...
                                        <div class="form-group has-feedback">
                                            <label class="form-label">{{ lang('Password') }} <span
                                                    class="text-red">*</span></label>
                                            <input class="form-control" placeholder="{{ lang('password') }}"
                                        ...
                                        <div class="form-group has-feedback ">
                                            <label class="form-label">{{ lang('Confirm Password') }} <span
                                                    class="text-red">*</span></label>
                                            <input class="form-control" placeholder="{{ lang('password') }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            @if ($customfield->fieldtypes == 'textarea')
                                                                <textarea name="custom_{{ $customfield->id }}" class="form-control" id="" cols="30" rows="5"
                                        ...
                                        <div class="form-group has-feedback">
                                            <label class="custom-control form-checkbox">
                                                ...
                                                <span class="custom-control-label">{{ lang('I agree with') }} <a
                                                        ...
                                                        class="text-primary" target="_blank">{{ lang('Terms of services') }}</a>
                                                </span>
                                            </label>
                                            ...
                                            @if (setting('RECAPTCH_ENABLE_REGISTER') == 'yes')
                                                <div class="form-group">
                                                    <div class="g-recaptcha @error('g-recaptcha-response') is-invalid @enderror"
                                                        data-sitekey="{{ setting('GOOGLE_RECAPTCHA_KEY') }}"></div>
                                                    <span class="text-danger" role="alert">
...
@endif -->
                                        ...
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-secondary btn-block"
                                                id="submitForm">{{ lang('Create Account') }}</button>

                                        </div>
                                        <div class="text-center mt-4">
                                            <p class="text-dark mb-0">{{ lang('Already have an account?') }}<a
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    if (data.success) {
                                        ...
                                        toastr.success(
                                            "{{ lang('The email verification link was successfully sent. Please check and verify your email.', 'alerts') }}"
                                            );
                                        $('#registermodal').modal('hide');
                                        $('#registerform').trigger("reset");
                                    }
