                            ...
                            <div class="wrapper wrapper2 box-shadow-0 border-0">
                                <form class="card-body pt-3" id="forgot_form" name="forgot_form"
                                    ...
                                    <div class="submit">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-block" id="forgotbtnsave" onclick="forgots();">{{lang('Submit')}}</button>
                                    </div>
            ...
            function forgots(){
                ...
                $.ajax({
                    ...
                    error: function(response){
                        toastr.error('{{lang('Please enter correct credentials.', 'alerts')}}');
                        $('#forgotbtnsave').html('Submit');
                    }
