                                                    ...
                                                    <form method="POST" action="{{url('/ticket/rating')}}">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="form-group mb-5">
                                                                    <label class="ps-1 me-5 text-center">
                                                                        ...
                                                                        <img src="{{asset('build/assets/images/rattings/rating1.png')}}" alt="img" class="w-7">
                                                                    ...
                                                                    <label class="ps-1 me-5 text-center">
                                                                        ...
                                                                        <img src="{{asset('build/assets/images/rattings/rating2.png')}}" alt="img" class="w-7">
                                                                    ...
                                                                    <label class="ps-1 me-5 text-center">
                                                                        ...
                                                                        <img src="{{asset('build/assets/images/rattings/rating3.png')}}" alt="img" class="w-7">
                                                                         <div class=" p-0 border-top-0 bd-t-0 py-1">
                                                                    ...
                                                                    <label class="ps-1 me-5 text-center">
                                                                        ...
                                                                        <img src="{{asset('build/assets/images/rattings/rating4.png')}}" alt="img" class="w-7">
                                                                         <div class=" p-0  border-top-0 bd-t-0 py-1">
                                                                    ...
                                                                    <label class="ps-1 me-5 text-center">
                                                                        ...
                                                                        <img src="{{asset('build/assets/images/rattings/rating5.png')}}" alt="img" class="w-7">
                                                                         <div class=" p-0 border-top-0 bd-t-0 py-1">
                                                        ...
                                                        <div class="card-footer">
                                                            ...
                                                            <div class="form-group float-end me-2  ">
                                                                <a href="{{route('home')}}"  class="btn btn-outline-danger">{{lang('Skip')}}</a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
