                                                        ...
                                                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-expanded="false">
                                                            <div class="panel-body p-0">
                                                                <div class="card border-0 shadow-none mb-0">
                                                                    <form method="POST" id="ReplyCommentForm" action="{{url('guest/ticket/'. encrypt($ticket->ticket_id))}}" enctype="multipart/form-data">
                                                                        @csrf
                                                                        @honeypot
                                                                        <input type="hidden" name="ticket_id" value="{{ $ticket->id }}">
                                                                        <div class="card-body">
                                                                        ...
                                                                        <div class="card-footer">
                                                                            <div class="form-group float-end">
                                                                                <button type="submit" id="ReplyCommentButton" class="btn btn-secondary" onclick="this.disabled=true;this.innerHTML=`Re-Opening <i class='fa fa-spinner fa-spin'></i>`;this.form.submit();">{{lang('Reply Ticket')}}</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
