						...
						<div class="col-md-6 justify-content-center mx-auto text-center">
                            ...
                            <div class="card">
                                <div class="card-body p-8 text-center">
                                    <img src="{{asset('build/assets/images/svgs/check.svg')}}" alt="img" class="w-10">
                                    ...
                                    <a class="btn ripple btn-primary" href="{{route('gusetticket',encrypt($ticket->ticket_id))}}">{{lang('View Ticket')}}</a>
								</div>
                            </div>
                        </div>
                    </div>
