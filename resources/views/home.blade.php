...
@section('styles')
		...
		<link href="{{asset('build/assets/plugins/owl-carousel/owl-carousel.css')}}?v=<?php echo time(); ?>" rel="stylesheet" />
...
@section('content')
    ...
    <!--Banner Section-->
    <section>
        <div class="banner-1 cover-image sptb-tab bg-background-support" data-bs-image-src="{{asset('build/assets/images/photos/banner2.jpg')}}">
                            ...
                            <div class="support-card card text-center wow" data-wow-delay="0.2s">
                                <div class="suuport-body">
                                    ...
                                    <div class="choose-icon">
                                        ...
                                        <img src="{{ route('getImage.url', ['imagePath' =>'uploads*featurebox*'.$box->image,'storage_disk'=>$box->storage_disk ?? 'public'])}}" alt="img" class="{{$box->image}}">
                                        @else
...
@if ($call->callcheck == 'on')
    ...
    <!--Call Action Section-->
    <section>
        <div class="banner-2 cover-image" data-bs-image-src="{{asset('build/assets/images/pattern/pattern2.png')}}">
            <div class="header-text content-text mb-0">
                <div class="container px-sm-0 px-7">
                    <div class="row">
                        ...
                        <div class="col-md-5 d-flex align-items-center justify-content-center">
                                @if ($call->image !== null)
                                <img src="{{ route('getImage.url', ['imagePath' =>'uploads*callaction*'.$call->image,'storage_disk'=>$call->storage_disk ?? 'public'])}}" alt="img" class="header-text3 call-to-action-image img-fluid">
                                @else
            ...
            <div class="container">
                ...
                <div class="row row-deck">
                    ...
                    @foreach ($categorys as $category)
                        @if ($category->articles()->where('status', 'Published')->latest()->simplepaginate(5)->isNotEmpty())
                                            ...
                                            <div class="col-xl-8 col-md-12 d-block mx-auto">
                                                <div class="testimonia">
                                                    <div class="testimonia-img mx-auto mb-3">
                                                        ...
                                                        <img src="{{ route('getImage.url', ['imagePath' =>'uploads*testimonial*'.$testimonials->image,'storage_disk'=>$testimonials->storage_disk ?? 'public'])}}" class="avatar avatar-xxl brround text-center mx-auto" alt="{{$testimonials->image}}">
                                                        @else
...
@section('scripts')
		...
		<script src="{{asset('build/assets/plugins/owl-carousel/owl-carousel.js')}}?v=<?php echo time(); ?>"></script>

		<!-- INTERNAL Index js-->
        @vite(['resources/assets/js/support/support-landing.js'])
		{{-- <script src="{{asset('build/assets/js/support/support-landing.js')}}?v=<?php echo time(); ?>"></script> --}}
