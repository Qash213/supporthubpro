...
class Ticket extends Model implements HasMedia
{
    ...
    protected $fillable = [
        'cust_id', 'category_id', 'image', 'ticket_id', 'title', 'priority', 'message', 'tickettype','imap_id','ticketreopen','storage_disk', 'MessageID', 'status','subject','user_id','project_id','auto_close_ticket','autoresponse',
        'project', 'purchasecode','item_name','purchasecodesupport','subcategory'
    ];
    ...
    {
        return $this->hasMany(Ticketviolation::class, 'ticket_id');
    }
